...
module.exports = {
  name: "membercount", //the command name for the Slash Command
  slashName: "membercount", //the command name for the Slash Command
  category: "Utility",
  aliases: ["members", "mc"], //the command aliases [OPTIONAL]
  description: "Gives you the member count of the server", //the command description for Slash Command Overview
  cooldown: 1,
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `Total Members: ${guild.memberCount}\nHumans: ${
            guild.members.cache.filter((fetchedMembers) => !fetchedMembers.user.bot)
              .size
          }\nBots: ${
            guild.members.cache.filter((fetchedMembers) => fetchedMembers.user.bot).size
          }`
        )
        .setColor(ee.color)
        .setTimestamp();
