...
module.exports = {
	name: "update", //the command name for the Slash Command
	slashName: "update", //the command name for the Slash Command
  	category: "Owner",
	aliases: [], //the command aliases [OPTIONAL]
	description: "Pull latest commits of the bot from github", //the command description for Slash Command Overview
	cooldown: 1,
