...
module.exports = {
	...
	slashName: "uptime", //the command name for the Slash Command
  	category: "Info",
	aliases: ["up"], //the command aliases [OPTIONAL]
	description: "tells you the uptime of the bot", //the command description for Slash Command Overview
	cooldown: 1,
    ...
    messageRun: async (client, message, args, plusArgs, cmdUser, text, prefix) => {
        ...
        message.reply(`Bot uptime: ${uptimeString}`);
